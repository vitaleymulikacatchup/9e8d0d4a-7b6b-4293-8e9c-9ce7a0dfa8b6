...
export const metadata: Metadata = {
  title: "Chunga-Changa Travel Agency - Your Adventure Awaits",
  description: "Discover extraordinary travel experiences with Chunga-Changa. Expert-guided tours to 120+ destinations worldwide. Custom itineraries, luxury packages, 24/7 support.",
  keywords: "travel agency, adventure tours, luxury travel, custom itineraries, guided tours, exotic destinations, travel packages",
  metadataBase: new URL("https://chunga-changa.com"),
  alternates: {
    canonical: "https://chunga-changa.com"
  },
  openGraph: {
    title: "Chunga-Changa Travel Agency - Your Adventure Awaits",
    description: "Discover extraordinary travel experiences with expert-guided tours to 120+ destinations worldwide.",
    siteName: "Chunga-Changa Travel Agency",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763714020236-l4b9xt5d.jpg",
      alt: "Exotic tropical paradise destination"
    }]
  },
  twitter: {
    ...
    title: "Chunga-Changa Travel Agency - Your Adventure Awaits",
    description: "Discover extraordinary travel experiences with expert-guided tours to 120+ destinations worldwide.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763714020236-l4b9xt5d.jpg"]
  },
  robots: {
    index: true,
    follow: true
